...
impl GraphicsPassGenerator for TrianglePass {
    fn make_gpu_render_pass(
        ...
        let vert_shader = vk_manager.make_shader_from_spv(
            "prism-renderer/src/triangle_pass/shaders/triangle.vert.spv".into(),
        ).ok().ok_or("Error loading triangle vert shader")?;
        let frag_shader = vk_manager.make_shader_from_spv(
            "prism-renderer/src/triangle_pass/shaders/triangle.frag.spv".into(),
        ).ok().ok_or("Error loading triangle vert shader")?;
